function O2corr = aaoptode_salpresscorr_Dchoice(O2raw,temp,sal,press,S0,D)

% This code allows enduser to change the pressure correction coefficient 
% 0.032 is the default D value. 
...
% D:           User input of pressure correction coefficient (default is
%                   0.032
% OUTPUT:
