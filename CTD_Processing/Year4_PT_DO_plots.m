...
plotm(ooi_latlon(:,1),ooi_latlon(:,2),'^','markersize',8,'MarkerFaceColor','k',...
    'MarkerEdgeColor','k')
hold on
% plotm(cast02u.lat(1),cast02u.lon(1),'.','markersize',30,'Color',blue)
% plotm(cast03u.lat(1),cast03u.lon(1),'.','markersize',30,'Color',blue)
% plotm(cast04u.lat(1),cast04u.lon(1),'.','markersize',30,'Color',blue)
% plotm(cast05u.lat(1),cast05u.lon(1),'.','markersize',30,'Color',yellow)
% plotm(cast06u.lat(1),cast06u.lon(1),'.','markersize',30,'Color',cyan)
plotm(cast07u.lat(1),cast07u.lon(1),'.','markersize',30,'Color',blue)
plotm(cast08u.lat(1),cast08u.lon(1),'.','markersize',30,'Color',navy)
plotm(cast09u.lat(1),cast09u.lon(1),'.','markersize',30,'Color',cyan)
plotm(cast10u.lat(1),cast10u.lon(1),'.','markersize',30,'Color',yellow)
plotm(cast11u.lat(1),cast11u.lon(1),'.','markersize',30,'Color',green)
plotm(cast12u.lat(1),cast12u.lon(1),'.','markersize',30,'Color',purple)
% plotm(cast13u.lat(1),cast13u.lon(1),'.','markersize',30,'Color',lightcyan)
...
legend('','OOI Asset','Cast 7','Cast 8','Cast 9','Cast 10','Cast 11','Cast 12','Location','southoutside')

subplot(1,3,2)
% plot(cast04d.DOcorr_umolkg,cast04d.pt,'Linewidth',1.2,'Color',blue)
% hold on
% plot(cast05d.DOcorr_umolkg,cast05d.pt,'Linewidth',1.2,'Color',yellow)
...
% hold on
% plot(cast08d.DOcorr_umolkg,cast08d.pt,'Linewidth',1.2,'Color',navy)
plot(cast09d.DOcorr_umolkg,cast09d.pt,'Linewidth',1.2,'Color',cyan)
hold on
plot(cast10d.DOcorr_umolkg,cast10d.pt,'Linewidth',1.2,'Color',yellow)
plot(cast11d.DOcorr_umolkg,cast11d.pt,'Linewidth',1.2,'Color',green)
plot(cast12d.DOcorr_umolkg,cast12d.pt,'Linewidth',1.2,'Color',purple)
% plot(cast13d.DOcorr_umolkg,cast13d.pt,'Linewidth',1.2,'Color',lightcyan)
...
subplot(1,3,3)
plot(btlsum_yr4_OOI.Winkler_umolkg,btlsum_yr4_OOI.pt,'.k','markersize',20)
hold on
% plot(cast04u.DOcorr_umolkg,cast04u.pt,'Linewidth',1.2,'Color',blue)
% plot(cast05u.DOcorr_umolkg,cast05u.pt,'Linewidth',1.2,'Color',yellow)
...
% plot(cast08u.DOcorr_umolkg,cast08u.pt,'Linewidth',1.2,'Color',navy)
plot(cast09u.DOcorr_umolkg,cast09u.pt,'Linewidth',1.2,'Color',cyan)
plot(cast10u.DOcorr_umolkg,cast10u.pt,'Linewidth',1.2,'Color',yellow)
plot(cast11u.DOcorr_umolkg,cast11u.pt,'Linewidth',1.2,'Color',green)
plot(cast12u.DOcorr_umolkg,cast12u.pt,'Linewidth',1.2,'Color',purple)
% plot(cast13u.DOcorr_umolkg,cast13u.pt,'Linewidth',1.2,'Color',lightcyan)
