...
downcasts = []; upcasts = []; 
%
% cal = cal_deep; SOC_type = 1; %%% The line to change 
% cal.casts = [1:145 147:214]; % SIO didn't process Cast 146
% cast_num = cal.casts;
...
if savefile == 1
    cd('G:\Shared drives\NSF_Irminger\OOI Cruises CTD Casts\CTD_Data\Alfresco\AR69-03')
    btl_num_deep = unique(btlsum_tbl.Cast);
    cast_num_deep = cast_num;
    btlsum_deep_tbl = btlsum_tbl;
    btlsum_deep = btlsum;
    dt_Processed_AR6903 = datetime('now'); 
    SBE_cal_deep = cal;
    upcasts_deep = upcasts;
    downcasts_deep = downcasts; 
    
    save AR6903_Processed_just_deep_cal_KF.mat upcasts_* downcasts_* btl_num_* cast_num_* SBE_cal* btlsum_* btlsum_tbl_* dt_Processed_*
end

%%
if savefile == 1
    cd('G:\Shared drives\NSF_Irminger\OOI Cruises CTD Casts\CTD_Data\Alfresco\AR69-03')
    btl_num_Wink1 = unique(btlsum_tbl.Cast);
    cast_num_Wink1 = cast_num;
    btlsum_Wink1_tbl = btlsum_tbl;
    btlsum_Wink1 = btlsum;
    dt_Processed_Wink1 = datetime('now'); 
    SBE_cal_Wink1 = cal;
    upcasts_Wink1 = upcasts;
    downcasts_Wink1 = downcasts; 
    SBE_caldeep_Wink1 = cal_deep;
    SBE_calall_Wink1 = cal_all;
    SBE_cal1_Wink1 = cal1;
    SBE_cal2_Wink1 = cal2;
    SBE_cal3_Wink1 = cal3;
    SBE_cal4_Wink1 = cal4;
    ...
    save AR6903_Processed_Wink1_cal_KF.mat upcasts_* downcasts_* btl_num_* cast_num_* SBE_cal* btlsum_* btlsum_tbl_* dt_Processed_*
end
%%
% for i = 1:length(btl_num)
