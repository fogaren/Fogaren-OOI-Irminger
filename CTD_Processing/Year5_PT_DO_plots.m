...
plotm(ooi_latlon(:,1),ooi_latlon(:,2),'^','markersize',8,'MarkerFaceColor','k',...
    'MarkerEdgeColor','k')
hold on
plotm(cast05u.lat(1),cast05u.lon(1),'.','markersize',30,'Color',green)
...
% plotm(cast12u.lat(1),cast12u.lon(1),'.','markersize',30,'Color',teal)
...
legend('','OOI Asset','Cast 5','Cast 6','Cast 7','Cast 8','Cast 9','Cast 10',...
    'Cast 13','Cast 14','Cast 15','Cast 21','Location','southoutside')
...
subplot(1,3,3)
plot(btlsum_yr5.Winkler_umolkg,btlsum_yr5.pt,'.k','markersize',20)
hold on
