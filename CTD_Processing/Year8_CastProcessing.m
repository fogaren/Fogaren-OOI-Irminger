...
dc_dir = 'G:\Shared drives\NSF_Irminger\OOI Cruises CTD Casts\CTD_Data\Alfresco\Year8\downcasts';
uc_dir = 'G:\Shared drives\NSF_Irminger\OOI Cruises CTD Casts\CTD_Data\Alfresco\Year8\upcasts';
...
bad_casts = [NaN; % downcasts
    10]'; % upcasts 
plot_calibrated_pTemp(downcasts,upcasts,cast_num,btlsum,cal,bad_casts,'Irminger Year 8')
%%
if savefile == 1
    ...
    cd(dir)
    save Year8_Processed_NLMR_KF.mat upcasts_yr* downcasts_yr* btl_num_yr* cast_num_yr* cal_yr* btlsum_yr* bad_casts dt_Processed
end
