...
% correction 
btl_dir = 'G:\Shared drives\NSF_Irminger\OOI Cruises CTD Casts\CTD_Data\Alfresco\Bottle_Files\Year4';
samp_dir = 'G:\Shared drives\NSF_Irminger\OOI Cruises CTD Casts\CTD_Data\Alfresco\Year4'; % Winkler file location 
Winkler_file = 'Irminger_Sea-04_AR21_Discrete_Summary_KF.xlsx'; % Winkler file name 
...
btlcasts = str2num(mybtlfiles(:,6:8)); % Pulls out cast numbers that have bottle files 
...
cast_ind7 = btlsum_tbl.Cast == 7;
cast_ind8 = btlsum_tbl.Cast == 8; 
Winklers_to_use = btlsum_tbl.Winkler_umolkg; 
Winklers_to_use(cast_ind7 == 1) = NaN; 
Winklers_to_use(cast_ind8 == 1) = NaN; 
...
xlabel('Winkler DO (\mumol/kg)')
grid on
sgtitle('Year 4 AR21: SOC_c_n')

%% Decided on SOC calibration 
SOC_type = 1; % variable by cast number 
Winklers_questionable = cal.Winkler_outliers; 
...
btlsum_tbl.NLMR_Outlier(btlsum_tbl.Cast == 7) = 1;
btlsum_tbl.NLMR_Outlier(btlsum_tbl.Cast == 8) = 1;
