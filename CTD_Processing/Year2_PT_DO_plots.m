...
plotm(cast05u.lat(1),cast05u.lon(1),'.','markersize',30,'Color',cyan)
plotm(cast06u.lat(1),cast06u.lon(1),'.','markersize',30,'Color',purple)
...
plotm(cast11u.lat(1),cast11u.lon(1),'.','markersize',30,'Color',maroon)
plotm(cast12u.lat(1),cast12u.lon(1),'.','markersize',30,'Color',navy)
...
legend('','OOI Asset','Cast 4','Cast 5','Cast 6','Cast 9',...
    'Cast 10','Cast 11','Cast 12','Cast 13','Location','southoutside')

subplot(1,3,2)
plot(cast04d.DOcorr_umolkg,cast04d.pt,'Linewidth',1.2,'Color',blue)
hold on
plot(cast05d.DOcorr_umolkg,cast05d.pt,'Linewidth',1.2,'Color',cyan)
plot(cast06d.DOcorr_umolkg,cast06d.pt,'Linewidth',1.2,'Color',purple)
...
plot(cast11d.DOcorr_umolkg,cast11d.pt,'Linewidth',1.2,'Color',maroon)
plot(cast12d.DOcorr_umolkg,cast12d.pt,'Linewidth',1.2,'Color',navy)
...
subplot(1,3,3)
plot(btlsum_yr2_OOI.Winkler_umolkg,btlsum_yr2_OOI.pt,'.k','markersize',20)
hold on
plot(cast04u.DOcorr_umolkg,cast04u.pt,'Linewidth',1.2,'Color',blue)
plot(cast05u.DOcorr_umolkg,cast05u.pt,'Linewidth',1.2,'Color',cyan)
plot(cast06u.DOcorr_umolkg,cast06u.pt,'Linewidth',1.2,'Color',purple)
...
plot(cast11u.DOcorr_umolkg,cast11u.pt,'Linewidth',1.2,'Color',maroon)
plot(cast12u.DOcorr_umolkg,cast12u.pt,'Linewidth',1.2,'Color',navy)
