...
subplot(2,2,1)
plot(btlsum.prs, mdlcal.Residuals.raw, 'k.','Markersize',20); hold on;
...
subplot(2,2,2)
plot(datenum(btlsum.Date) - min(datenum(btlsum.Date)), mdlcal.Residuals.raw, 'k.','Markersize',20); hold on;
ylabel({'Residual, Winkler - NLMR output','(\mumol/kg)'})
...
subplot(2,2,3)
plot(btlsum.t, mdlcal.Residuals.raw, 'k.','Markersize',20); hold on;
ylabel({'Residual, Winkler - NLMR output','(\mumol/kg)'})
...
subplot(2,2,4)
plot(btlsum.Winkler_umolkg, mdlcal.Residuals.raw, 'k.','Markersize',20); hold on;
ylabel({'Residual, Winkler - NLMR output','(\mumol/kg)'})
