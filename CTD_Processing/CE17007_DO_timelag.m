...
cd('C:\Users\fogaren\Documents\SBE\CE17007') % location of cnv files on computer 
...
cast.prho = gsw_rho_CT_exact(SA,CT,0);
...
subplot(1,6,1)
plot(cast.prho(cast.pm >= pres),cast.pm(cast.pm >= pres))
axis ij
ylabel('Pressure')
xlabel('Pot. Density')
...
plot(cast.sbeox0V(cast.pm >= pres),cast.prho(cast.pm >= pres))
ylabel('Pot. Density')
xlabel('DO (V)')
title('0 sec align')
...
plot(cast.DO_a1v(cast.pm >= pres),cast.prho(cast.pm >= pres))
ylabel('Pot. Density')
xlabel('DO (V)')
...
plot(cast.DO_a2v(cast.pm >= pres),cast.prho(cast.pm >= pres))
ylabel('Pot. Density')
xlabel('DO (V)')
...
plot(cast.DO_a3v(cast.pm >= pres),cast.prho(cast.pm >= pres))
ylabel('Pot. Density')
xlabel('DO (V)')
