...
plotm(cast10u.lat(1),cast10u.lon(1),'.','markersize',30,'Color',navy)
...
legend('','OOI Asset','Cast 5','Cast 6','Cast 7','Cast 8','Cast 9','Cast 10','Location','southoutside')
...
plot(cast10d.DOcorr_umolkg,cast10d.pt,'Linewidth',1.2,'Color',navy)
...
subplot(1,3,3)
plot(btlsum_yr3_OOI.Winkler_umolkg,btlsum_yr3_OOI.pt,'.k','markersize',20)
hold on
...
plot(cast10u.DOcorr_umolkg,cast10u.pt,'Linewidth',1.2,'Color',navy)
